	...
	pst2.setString(2,password);
		...
		try(ResultSet rst = pst2.executeQuery()){
			...
			if(rst.next()) {
				...
				User curUser = new User(rst.getInt(1),rst.getString(2),rst.getString(3),rst.getString(4),rst.getString(5),rst.getDate(6),rst.getBoolean(7),rst.getString(8));			
				//int userId, String firstName, String lastName, String email, String password, Date dob,boolean votingStatus, String role
